...
(function($) {
    ...
    $.fn.lightGallery = function(options) {
        ...
        var setUp = {
            ...
            structure: function() {
                $('body').append('<div id="lightGallery-outer" class="' + settings.addClass + '"><div id="lightGallery-Gallery"><div id="lightGallery-slider"></div></div></div>').addClass('lightGallery');
            ...
            slide: function(index) {
                ...
                prevIndex = index; 
                lightGalleryOn === false ? settings.onOpen.call(this, plugin) : settings.onSlideAfter.call(this, plugin, index);
                setTimeout(function() {
                    lightGalleryOn = true;
                });
                usingThumb = false;
